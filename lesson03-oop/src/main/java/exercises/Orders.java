...
public class Orders {
	...
	public static void exportBill(Order order) {
		System.out.println("Họ tên: " + order.getCustomer());
		...
		for(int i = 0; i < itemInfos.length; i++) {
			...
			//datetime => 05.12.2020 & item.getCost() > 590
			//minus 10%
			
			//A: 600 3 => 1800 => 1500
			//B: 500 2 => 1000
			if(order.getDatetime().toLocalDate().isEqual(LocalDate.of(2020, Month.DECEMBER, 4))
					&& cost > 590) {
