...
import java.util.Scanner;
	 ...
	 // Chương trình chỉ mới tìm được một phần tử yên ngựa
	// Nếu có từ 2 phần tử yên ngựa trở lên trong ma trận thì chương trình chỉ trả về 1 giá trị.
	// Không biết cách làm cho nó trả về nhiều hơn 1 phần tử yên ngựa :(
