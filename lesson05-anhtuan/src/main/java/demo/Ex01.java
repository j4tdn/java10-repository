...
public class Ex01 {
	public static void main(String[] args) {
		...
		int[] uniqueArray = getUniqueElemants(digits);
	...
	private static int[] getUniqueElemants(int[] elements) {
	...
	private static void printf(int[] elememts) {
		for (int element : elememts) {
