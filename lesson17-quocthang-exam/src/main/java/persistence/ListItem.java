...
public class ListItem {
	...
	public ListItem(Integer igroupId, String iGroupName, Integer itemId, String itemName, Integer price,
	...
	public String toString() {
		return "ListItem [igroupId=" + igroupId + ", iGroupName=" + iGroupName + ", itemId=" + itemId + ", itemName="
				+ itemName + ", price=" + price + ", purchasePrice=" + purchasePrice + ", amount=" + amount + "]";
	}
