...
public class Ex03 {
	public static void main(String[] args) {
		...
		// Comparator
		Arrays.sort(items, 
				Comparator.comparing((Item i) -> i.getName()).thenComparing((Item i) -> i.getAge()));
		
		
//		Function<Item, Integer> func = i -> i.getAge();
//		Arrays.sort(items, Comparator.comparing(func).reversed());
	...
	private static class Item  { // implements Comparator
		private Integer id;
		private String name;
		private Integer age;
