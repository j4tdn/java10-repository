...
public class StreamApp {
	...
	private static List<Dish> getAll() {
		return Arrays.asList(new Dish("1", "D1", 308, Kind.OTHER, false), new Dish("2", "D2", 605, Kind.OTHER, true),
				new Dish("3", "D3", 329, Kind.OTHER, true), new Dish("4", "D4", 302, Kind.MEAT, false),
				new Dish("5", "D5", 480, Kind.MEAT, false), new Dish("6", "D6", 480, Kind.MEAT, false),
